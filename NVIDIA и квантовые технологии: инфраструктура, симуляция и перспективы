...
Благодаря этому подходу алгоритм можно написать один раз, а выполнять где угодно – на любом QPU или на GPU-суперкомпьютере.
...
## NVQLink — новая архитектура связности
...
Заявление прозвучало на фоне некоторой эйфории вокруг квантовых достижений и охладило пыл инвесторов: после слов Хуанга акции ряда квантовых стартапов, уже торгующихся на бирже, пошли вниз. Позже глава NVIDIA был вынужден смягчить свою позицию, отметив, что квантовые технологии, безусловно, «имеют потенциал изменить всё», но пока остаются невероятно сложными в реализации.
...
Стоит также понимать, что сферы применения квантовых компьютеров пока ограничены определенными задачами (факторизация, квантовая химия, оптимизация, моделирование квантовых систем). Даже достигнув зрелости, квантовые решения не вытеснят универсальные компьютеры, а лишь дополнят их в узких областях.
